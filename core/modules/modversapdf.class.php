...
/**
 * 	\defgroup   versapdf     Module versapdf
 *  \brief      versapdf module descriptor.
 *
 *  \file       htdocs/versapdf/core/modules/modversapdf.class.php
 *  \ingroup    versapdf
 *  \brief      Description and activation file for module versapdf
 */
...
/**
 *  Description and activation class for module versapdf
 */
class modversapdf extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->module_parts = array(
									...
									'css' => array('/versapdf/css/versapdf.css.php'),	// Set this to relative path of css file if module has its own css file
	 								'js' => array('/versapdf/js/versapdf.js.php'),          // Set this to relative path of js file if module must load a js on all pages
		...
		// Example: this->dirs = array("/versapdf/temp","/versapdf/subdir");
		$this->dirs = array();

		// Config pages. Put here list of php page, stored into versapdf/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@versapdf");
		...
		$this->langfiles = array("versapdf@versapdf");
		$this->warnings_activation = array();                     // Warning to show when we activate module. array('always'='text') or array('FR'='textfr','ES'='textes'...)
		$this->warnings_activation_ext = array();                 // Warning to show when we activate an external module. array('always'='text') or array('FR'='textfr','ES'='textes'...)

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(0=>array('VERSAPDF_MYNEWCONST1','chaine','myvalue','This is a constant to add',1),
		...
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:mylangfile@versapdf:$user->rights->versapdf->read:/versapdf/mynewtab1.php?id=__ID__',  					// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@versapdf:$user->rights->othermodule->read:/versapdf/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		...
		if (! isset($conf->versapdf) || ! isset($conf->versapdf->enabled))
        {
        	$conf->versapdf=new stdClass();
        	$conf->versapdf->enabled=0;
        }
        ...
        $this->dictionaries=array(
            ...
            'tabcond'=>array($conf->versapdf->enabled,$conf->versapdf->enabled,$conf->versapdf->enabled)												// Condition to show each dictionary
        );
        */


        // Boxes/Widgets
		// Add here list of php file(s) stored in versapdf/core/boxes that contains class to show a widget.
        $this->boxes = array(
        	0=>array('file'=>'versapdfwidget1.php@versapdf','note'=>'Widget provided by versapdf','enabledbydefaulton'=>'Home'),
        	//1=>array('file'=>'versapdfwidget2.php@versapdf','note'=>'Widget provided by versapdf'),
        	//2=>array('file'=>'versapdfwidget3.php@versapdf','note'=>'Widget provided by versapdf')
        );


		// Cronjobs (List of cron jobs entries to add when module is enabled)
		$this->cronjobs = array(
			0=>array('label'=>'MyJob label', 'jobtype'=>'method', 'class'=>'/versapdf/class/versapdfmyjob.class.php', 'objectname'=>'versapdfMyJob', 'method'=>'myMethod', 'parameters'=>'', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>true)
		);
		...
		$this->rights[$r][4] = 'read';				// In php code, permission will be checked by test if ($user->rights->versapdf->level1->level2)
		$this->rights[$r][5] = '';				    // In php code, permission will be checked by test if ($user->rights->versapdf->level1->level2)

		$r++;
		$this->rights[$r][0] = $this->numero + $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'Create/Update objects of My Module';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		$this->rights[$r][4] = 'create';				// In php code, permission will be checked by test if ($user->rights->versapdf->level1->level2)
		$this->rights[$r][5] = '';				    // In php code, permission will be checked by test if ($user->rights->versapdf->level1->level2)
		...
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		$this->rights[$r][4] = 'delete';				// In php code, permission will be checked by test if ($user->rights->versapdf->level1->level2)
		$this->rights[$r][5] = '';				    // In php code, permission will be checked by test if ($user->rights->versapdf->level1->level2)
		...
		$this->export_label[$r]='versapdf';	                         // Translation key (used only if key ExportDataset_xxx_z not found)
        $this->export_enabled[$r]='1';                               // Condition to show export in list (ie: '$user->id==3'). Set to 1 to always show when module is enabled.
        $this->export_icon[$r]='generic:versapdf';					 // Put here code of icon then string for translation key of module name
		//$this->export_permission[$r]=array(array("versapdf","level1","level2"));
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/versapdf/sql/');
