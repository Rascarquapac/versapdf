...
/**
 * \file    modulebuilder/template/core/boxes/versapdfwidget1.php
 * \ingroup versapdf
 * \brief   Widget provided by versapdf
 *
 ...
 */
class versapdfwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "versapdfbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "versapdf@versapdf";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->versapdf->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/versapdf/class/versapdf.class.php";

		// Populate the head at runtime
		$text = $langs->trans("versapdfBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_versapdf@versapdf',
