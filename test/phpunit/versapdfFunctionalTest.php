...
/**
 * \file    test/functional/versapdfFunctionalTest.php
 * \ingroup versapdf
 ...
 *
 * @package Testversapdf
 */
class versapdfFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/versapdf/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('versapdf/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/versapdf/admin/about.php');
		$this->authenticate();
		return $this->assertContains('versapdf/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('versapdfwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modversapdf_versapdfTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modversapdf_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
