...
/**
 * \file    class/actions_versapdf.class.php
 * \ingroup versapdf
...
class Actionsversapdf
{
	...
	public function addMoreMassActions($parameters, &$object, &$action, $hookmanager)
	{
	    ...
	    {
	        $this->resprints = '<option value="0"'.($disabled?' disabled="disabled"':'').'>'.$langs->trans("versapdfMassAction").'</option>';
	    }
