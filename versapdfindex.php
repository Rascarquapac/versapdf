...
$head[$h][0] = dol_buildpath("/custom/versapdf/versapdfindex.php", 1);
...
print '<tr class="oddeven"><td>'.$langs->trans("QuantityColumnWidth").'</td><td>';
$versapdf_column_width=(! empty($conf->global->VERSAPDF_COLWIDTH_QTY)?$conf->global->VERSAPDF_COLWIDTH_QTY:'0');
print $form->selectarray('VERSAPDF_COLWIDTH_QTY', $arraychoices,$versapdf_column_width);
print "</td></tr>\n";
...
print '<tr class="oddeven"><td>'.$langs->trans("DiscountColumnWidth").'</td><td>';
$versapdf_column_width=(! empty($conf->global->VERSAPDF_COLWIDTH_DISCOUNT)?$conf->global->VERSAPDF_COLWIDTH_DISCOUNT:'0');
print $form->selectarray('VERSAPDF_COLWIDTH_DISCOUNT', $arraychoices,$versapdf_column_width);
print "</td></tr>\n";

// TotalHT column width
print '<tr class="oddeven"><td>'.$langs->trans("TotalHTColumnWidth").'</td><td>';
$versapdf_column_width=(! empty($conf->global->VERSAPDF_COLWIDTH_TOTALHT)?$conf->global->VERSAPDF_COLWIDTH_TOTALHT:'0');
print $form->selectarray('VERSAPDF_COLWIDTH_TOTALHT', $arraychoices,$versapdf_column_width);
print "</td></tr>\n";

// Picture column width
print '<tr class="oddeven"><td>'.$langs->trans("PictureColumnWidth").'</td><td>';
$versapdf_column_width=(! empty($conf->global->VERSAPDF_COLWIDTH_PICTURE)?$conf->global->VERSAPDF_COLWIDTH_PICTURE:'0');
print $form->selectarray('VERSAPDF_COLWIDTH_PICTURE', $arraychoices,$versapdf_column_width);
print "</td></tr>\n";

// Desription column width
print '<tr class="oddeven"><td>'.$langs->trans("DescriptionColumnWidth").'</td><td>';
$versapdf_column_width=(! empty($conf->global->VERSAPDF_COLWIDTH_DESCRIPTION)?$conf->global->VERSAPDF_COLWIDTH_DESCRIPTION:'0');
print $form->selectarray('VERSAPDF_COLWIDTH_DESCRIPTION', $arraychoices,$versapdf_column_width);
print "</td></tr>\n";
print '</table>';
