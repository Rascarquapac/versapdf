...
- Clone the repository in ```$dolibarr_main_document_root_alt/versapdf```

```sh
git clone git@github.com:Dolibarr/dolibarr-module-template.git versapdf
```
